...
public class ChainDao implements Dao<String, ChainVO> {
	...
	public void update(ChainVO model) {
		chainmapper.update(model);

	}

	@Override
	public ChainVO selectname(String chainID) {
		return chainmapper.selectchainname(chainID);
	}
	


	@Override
	public void applycnt(ChainVO model) {
		chainmapper.applycnt(model);
