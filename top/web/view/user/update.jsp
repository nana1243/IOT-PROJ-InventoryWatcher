...
<body class="login">
	<div class="wrapper wrapper-login">
		<div class="container container-login animated fadeIn">
			<c:forEach var="hqlist" items="${hqlist}">
				<h3 class="text-center">${hqlist.hqID}님의수정 PAGE</h3>
				<div class="login-form">

					<form class="signupform" action="updateimpl.top" method="post"
						accept-charset="utf-8" novalidate="novalidate">

						<div class="form-group">
							<label for="cname" class="placeholder"><b>chainname</b></label> <input
								id="cname" name="cname" type="text" class="form-control"
								value="${hqlist.hqName}">
						</div>
						...
						<div class="form-group">
							...
							<input id="hqpwd" name="hqpwd" type="password" value="${hqlist.hqPwd}"
						...
						<div class="form-group">
							<label for="confirmpassword" class="placeholder"><b>Confirm
								...
								type="password" onkeyup="confirm()" class="form-control" value="${hqlist.hqPwd}"
								required> <font size="2" id="check" color="red"></font>
						</div>
						...
						<div class="form-group">
							...
							<input id="hqphone" name="hqphone" type="text"
								value="${hqlist.hqPhone}" class="form-control" required>
						</div>
						<!--  phone  END -->
						...
						<div class="form-group">
							...
							<a href="#" class="link float-right"> <span class="btn"
								...
								style="width: 100px" id="chaincnt" name="chaincnt"
								value="${hqlist.chainCount}" class="form-control">
						</div>
						...
						<div id="addressarea">
							...
							<input type="text" id="address" name="caddr"
								...
								onclick="goPopup()" value="${hqlist.hqAddress}">
						</div>
						<!-- 본사주소  END -->
