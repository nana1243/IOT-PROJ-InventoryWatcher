			...
			<ul class="nav">
				...
				<li class="nav-item"><a data-toggle="collapse" href="#tables">
					...
					<div class="collapse" id="tables">
						<ul class="nav nav-collapse">
							<li><a href="tables/tables.html"> <span class="sub-item">Basic
										Table</span>
							</a></li>
				...
				<li class="nav-item"><a data-toggle="collapse" href="#charts">
					...
					<div class="collapse" id="charts">
						<ul class="nav nav-collapse">
							<li><a href="charts/charts.html"> <span class="sub-item">Chart
										Js</span>
							</a></li>
				...
				<li class="nav-item"><a data-toggle="collapse" href="#submenu">
					...
					<div class="collapse" id="submenu">
						<ul class="nav nav-collapse">
							...
							<li><a data-toggle="collapse" href="#subnav2"> <span
									class="sub-item">Level 1</span> <span class="caret"></span>
							</a>
