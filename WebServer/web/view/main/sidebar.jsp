			...
			<ul class="nav">
				...
				<li class="nav-item"><a data-toggle="collapse" href="#submenu"
					class="collapsed" aria-expanded="false"> <i
						...
						<p>chaincontainer</p> <span class="caret"></span></a>
						...
						<ul>
							<li class="submenu"><a data-toggle="collapse"
								...
								onclick="location.href='containerRegisterWizard.top'"> <span
									class="sub-item">container1</span>
							</a></li>
							<li class="submenu"><a data-toggle="collapse"
								href="#subnav1" class=""
								onclick="location.href='showContainerUpdateList.top'"> <span
									class="sub-item">container2</span>
							</a></li>
						</ul>
					</div></li>
				...
				<li class="nav-item"><a data-toggle="collapse" href="#maps">
						<i class="fas fa-map-marker-alt"></i>
						<p>Orders</p> <span class="caret"></span>
				</a>
					<div class="collapse" id="maps">
						<ul class="nav nav-collapse">
							<li><a href="main.top" onclick="popup()"> <span
									class="sub-item">Orders</span>
							</a></li>
							<li><a href="orderStatus.top"> <span class="sub-item">Order
										Status</span>
							</a></li>
						</ul>
					</div></li>
