...
public class IngredientVO {
	...
	public IngredientVO(String ingID, String ingCategory, String ingName, double ingPrice, String ingUnit,
			String ingBrand, String ingType, double ingWeight, String ingRegDate, String ingLink, int ingLinkCount,
			String ingImgName, String hqID) {
		super();
		this.ingID = ingID;
	...
	public String toString() {
		return "IngredientVO [ingID=" + ingID + ", ingCategory=" + ingCategory + ", ingName=" + ingName + ", ingPrice="
				...
				+ ", ingImgName=" + ingImgName + ", hqID=" + hqID + "]";
	}
