...
//        initUI2();
    ...
    class FetchData implements Runnable {
       ...
       String urlstr = "http://192.168.43.110/top/fetchContainerData.top?chainID=";
...
//                    conList.get(i).setConCurrWeight(ranNum);
                    ...
                    new Thread(new SendContainerInfoToWebServer(conList.get(i).getConID(), conList.get(i).getConFullWeight(), Math.abs(conCurrentWeight), conList.get(i).getConWarningWeight(), conList.get(i).getIngID(), conList.get(i).getIngName(), conList.get(i).getChainID(), MainActivity.userID)).start();
    ...
    class SendContainerInfoToWebServer implements Runnable {
       ...
       // String urlstr = "http://192.168.43.2:8080/top/realtimecontainerdata.top?";
        String urlstr = "http://192.168.43.110/top/realtimecontainerdata.top?";
